jQuery(document).ready(function(){
	...
	var servicesList = {
		...
		lpg: {
			title: 'LPG массаж',
			deskTopimg: 'img/services/26.png',
			mobileImg: 'img/services/mobile/27.png',
			price: '1500-5000 ₽',
			content: `<p>УLPG массаж – современная аппаратная методика, основанная на сочетании вакуумного и вибровоздействия на лицо или тело.</p>
			<p>Результат после курса процедур LPG:</p>
			<ul> 
				<li>Улучшение контуров фигуры, выравнивание кожных покровов, </li>
				<li>Коррекция результатов ранее проведенной липосакции, </li>
				<li>Нормализация кровотока и лимфообращения в местах воздействия, </li>
				<li>Выраженное повышение тонуса кожи,</li>
				<li>Улучшение микроциркуляции и обмена веществ в тканях,</li>
				<li>Коррекция объемов тела, устранение подкожно-жировой ткани,</li>
				<li>Улучшение общего самочувствия и состояния клиента,</li>
				<li>Лимфодренаж и устранение проявлений целлюлита</li>
			</ul>
			<p>Процедуру проводим на оригинальном аппарате из Франции по методике производителя. Это не аналог!</p>`
		},
		massage: {
