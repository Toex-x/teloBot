jQuery(document).ready(function(){
	...
	var servicesList = {
		...
		lpg: {
			...
			mobileImg: 'img/services/mobile/28.png',
			price: '1500-5000 ₽',
			content: `<p>LPG массаж – современная аппаратная методика, основанная на сочетании вакуумного и вибровоздействия на лицо или тело.</p>
